...
$page_canonical = "https://d-neko.com/service_blog.php";
$page_noindex = true;
$page_head = <<<'HTML'
<script>
  (function () {
    var storageKey = "dneko-opening-seen-v1";
    var shouldShow = true;
    ...
    if (shouldShow) {
      document.documentElement.classList.add("dneko-opening-pending");
      window.__dnekoOpeningFailsafe = window.setTimeout(function () {
...
HTML;
$page_script = '<script src="js/dneko-opening.js" defer></script>';
include_once './header.php';
?>

<div id="dneko-opening" class="dneko-opening" aria-hidden="true">
  <div class="dneko-opening__stage">
    <div class="dneko-opening__hand">
      <p class="dneko-opening__label">デザインのネコの手</p>
      <svg class="dneko-opening__cat-crop" viewBox="0 0 165 160" aria-hidden="true" focusable="false">
        <image href="<?php echo $img; ?>/logo.png" width="424" height="160"></image>
      </svg>
      <p class="dneko-opening__welcome">ようこそ！</p>
    </div>
    <div class="dneko-opening__word">
      <svg class="dneko-opening__word-crop" viewBox="158 60 266 100" aria-hidden="true" focusable="false">
        <image href="<?php echo $img; ?>/logo.png" width="424" height="160"></image>
      </svg>
      <p>デザインを、もっとたのしく。</p>
    </div>
    <div class="dneko-opening__lockup">
      <img src="<?php echo $img; ?>/logo.png" alt="">
      <p>WELCOME TO DEZANEKO</p>
