        ...
        <div>
            ...
            <div class="mbox act set">
                <div class="sbox bold act blur">
                    ...
                    <div class="tcenter">
                        <p>
                            <span class="blue">ホームページを始めたいけど、どこから手をつければいいのかわからない。</span><br>
                            <span class="blue">デザインも設定も難しそうで、途中で挫折しそう…。</span>
                        </p>
                        <p>
                            そんなあなたに寄り添う、<br>
                            <span class="underline_y">ホームページづくりと運営サポートのネコの手が「デザネコ」</span>です。
                        </p>
                    </div>
                </div>
            </div>
                ...
                <div>
                    ...
                    <ul class="voice grid set2 gap1">
                        ...
                        <li>
                            ...
                            <div class="speech act inleft">
                                <p class="fs_size_m">ホームページを始めたいけど、何から始めたらいいかわからない⋯</p>
                            </div>
                        </li>
                        <li>
                            <div class="figure">
                            ...
                            <div class="speech act inleft">
                                <p class="fs_size_m">副業・アフィリエイト・ライフスタイル発信など、目的に合ったホームページを育てたい⋯</p>
                            </div>
                        </li>
                        <li>
                            <div class="figure">
                            ...
                            <div class="speech act inleft">
                                <p class="fs_size_m">ホームページを作ったはいいけど、更新やメンテナンスが続かず放置してしまった⋯</p>
                            </div>
                        </li>
                        <li>
                            <div class="figure">
                        ...
                        <li>
                            ...
                            <div class="speech act inleft">
                                <p class="fs_size_m">小さなお店や教室の情報発信に、手作り感のあるホームページを使いたい⋯</p>
                            </div>
                        </li>
                        <li>
                            <div class="figure">
                            ...
                            <div class="speech act inleft">
                                <p class="fs_size_m">ネコの手も借りたい忙しさだけど、ちゃんとしたホームページを運営したい⋯</p>
                            </div>
                        </li>
                    ...
                    <div class="sbox act blur">
                        <dl class='accordion'>
                            ...
                            <dd class='panel'>
                                <div class='inner'>
                                    <p>もちろん大丈夫です！<br>
                                        専門的な操作や難しい設定は、こちらで代行いたします。ホームページ記事の書き方や画像の入れ方など、基本的な使い方もわかりやすくサポートいたしますので、パソコンが苦手な方でも安心してご利用いただけます。</p>
                                </div>
                            </dd>
                            ...
                            <dd class='panel'>
                                <div class='inner'>
                                    <p>どのようなデザインにしたいのか？色味や写真のイメージ、そのほか雰囲気などなどをお聞きします。ご希望に応じて、ホームページの全体的なデザイン（配色・ロゴ・レイアウトなど）をカスタマイズ可能です。<br>
                            ...
                            <dd class='panel'>
                                <div class='inner'>
                                    <p>ホームページ初心者の方や、副業を始めたい方、小さなお店・教室のオーナー様などに多くご利用いただいています。<br>
                                        「パソコンが苦手だけど、しっかりしたホームページがほしい」という方にとって、身近で頼れる味方になるサービスです。</p>
                                </div>
                            </dd>
                        ...
                        <dl class="flow_dl">
                            <div class="inner">
                                ...
                                <dd class="act inright">
                                    ...
                                    「ホームページってどんなことができるの？」「自分にもできる？」など、どんな小さな疑問でも大歓迎です。サービスの内容や流れをわかりやすくご説明いたします。
                                </dd>
                            </div>
                            <div class="inner">
                                ...
                                <dd class="act inright">
                                    ...
                                    お客様の目的や理想のイメージを丁寧にお聞きしながら、ホームページの方向性や必要な機能、デザインのテイストなどをご提案します。<br>
                            ...
                            <div class="inner">
                                ...
                                <dd class="act inright">
                                    ...
                                    オリジナルデザインで、世界にひとつだけのホームページをお作りします。制作期間は通常2〜3週間ほどです。
                                </dd>
                            </div>
                            <div class="inner">
                            ...
                            <div class="inner">
                                ...
                                <dd class="act inright">
                                    ...
                                    公開後も月額プランにて、ホームページの更新・修正・ご相談などをしっかりサポート。<br>
                                    「ちょっとだけ聞きたい」「ここだけ直したい」といった小さなことも、お気軽にご相談ください。あなただけのオリジナルのホームページを、一緒に“育てて”いきましょう。
                                </dd>
                            </div>
                        </dl>
                    </div>
