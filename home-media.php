<!-- YouTube and goods -->
<section>
<div class="dr_section dr_movies">
...
<article class="dr_movie_card"><button class="dr_movie_trigger" type="button" data-youtube-id="OLienJNZC9Y" aria-haspopup="dialog" aria-label="【BGM】やる気がみなぎる！沖縄方言メロコアメドレー7曲｜Okinawa Punkを再生"><figure><img src="https://i.ytimg.com/vi/OLienJNZC9Y/hqdefault.jpg" alt="" width="480" height="360" loading="lazy" decoding="async"><i class="fa-solid fa-play" aria-hidden="true"></i></figure><h3>【BGM】やる気がみなぎる！沖縄方言メロコアメドレー7曲｜Okinawa Punk</h3></button></article>
<article class="dr_movie_card"><button class="dr_movie_trigger" type="button" data-youtube-id="-YgZpyIcNf4" aria-haspopup="dialog" aria-label="Cute Cat Chiptune 🐈‍⬛🎮 Neon Beats for Gaming &amp; Good Vibes | MOJA! NYA!を再生"><figure><img src="https://i.ytimg.com/vi/-YgZpyIcNf4/hqdefault.jpg" alt="" width="480" height="360" loading="lazy" decoding="async"><i class="fa-solid fa-play" aria-hidden="true"></i></figure><h3>Cute Cat Chiptune 🐈‍⬛🎮 Neon Beats for Gaming &amp; Good Vibes | MOJA! NYA!</h3></button></article>
            <article class="dr_movie_card">
