      ...
      <div id="marutto_top" class="marutto_hero">
        <div class="marutto_campaign_limit">
          <div class="marutto_campaign_limit_inner">
            <h1>
              <span class="marutto_campaign_service tcenter">チラシとホームページ<br>まるっとお任せプラン</span>
              <span class="marutto_campaign_limit_title tcenter">守成クラブの方 <strong>毎月2組限定</strong></span>
            </h1>
      ...
      <div class="marutto_section marutto_worries">
        <div class="marutto_inner">
          <div class="marutto_heading">
            <p>Problem</p>
            <h2>こんなお悩み<br class="sponly">ありませんか？</h2>
          </div>
    ...
    <section>
      <div id="about_plan" class="marutto_section marutto_solution">
        <div class="marutto_inner">
          <div class="marutto_heading">
            <p>Solution</p>
            <h2><b class="orange">“入口のチラシ”</b><br class="sponly">×<br class="sponly"><b class="green">“受け皿のHP”</b>で、<br>集客が続く仕組み。</h2>
          </div>
          ...
          <div class="marutto_feature_grid">
            <article><span>特徴 1</span><i class="fa-solid fa-user-pen" aria-hidden="true"></i>
              <h3 class="orange">20年・1,000件超の経験で<br>一貫プロデュース</h3>
              <p>大手のような分業ではなく、ヒアリングから公開後の改善まで、比嘉が最初から最後まで責任を持って担当します。</p>
            </article>
            <article><span>特徴 2</span><i class="fa-solid fa-chart-line" aria-hidden="true"></i>
              <h3 class="orange">HP制作後も、<br>数字で改善サポート</h3>
              <p>閲覧数・男女比・検索キーワード等を数値化し、改善案をご提案。狙ったターゲットへの届け方や検索上位表示のご相談にも柔軟に対応します。</p>
            </article>
            <article><span>特徴 3</span><i class="fa-solid fa-palette" aria-hidden="true"></i>
              <h3 class="orange">印刷物以外のデザインも<br>まとめてお任せ</h3>
              <p>シールやオリジナルグッズなど、大手では高額だったデザインもご相談可能。ブランドの雰囲気を揃えながら、低価格でご提供します。</p>
            </article>
          </div>
          <div class="marutto_section_action"><a class="marutto_cta marutto_cta_compact" href="<?php echo htmlspecialchars($marutto_page_path, ENT_QUOTES, 'UTF-8'); ?>#contact_form"><i class="fa-regular fa-envelope" aria-hidden="true"></i><span>まずは無料相談する<small>チラシだけのご相談も歓迎です</small></span><i class="fa-solid fa-chevron-down" aria-hidden="true"></i></a></div>
        </div>
      </div>
    </section>
    ...
    <section>
      <div class="marutto_section marutto_results">
        <div class="marutto_inner">
          <div class="marutto_heading">
            <p>Results</p>
            <h2>これまでに手がけた<br class="sponly">ホームページは<br>
              <strong>789社</strong>。
            </h2>
          </div>
          ...
          <div class="marutto_results_grid">
            <div class="marutto_work_samples">
              <h3>制作実績の一例</h3>
              <div>
                <figure><img src="<?php echo $img; ?>/web_design/nicoli-music.com.webp" alt="音楽教室のホームページ制作実績" width="480" height="360" loading="lazy" decoding="async">
                  <figcaption>音楽教室</figcaption>
                </figure>
                <figure><img src="<?php echo $img; ?>/web_design/yukyu-okinawa.com.webp" alt="旅行会社のホームページ制作実績" width="480" height="360" loading="lazy" decoding="async">
                  <figcaption>旅行・観光</figcaption>
                </figure>
                <figure><img src="<?php echo $img; ?>/web_design/arakaki-grow.co.jp.webp" alt="企業ホームページの制作実績" width="480" height="360" loading="lazy" decoding="async">
                  <figcaption>企業サイト</figcaption>
                </figure>
                <figure><img src="<?php echo $img; ?>/web_design/churasakura.okinawa.webp" alt="沖縄県内事業者のホームページ制作実績" width="480" height="360" loading="lazy" decoding="async">
                  <figcaption>地域サービス</figcaption>
                </figure>
                <figure><img src="<?php echo $img; ?>/web_design/tedakonurseryschool.com.webp" alt="てだこ保育園のホームページ制作実績" width="480" height="360" loading="lazy" decoding="async">
                  <figcaption>保育園</figcaption>
                </figure>
                <figure><img src="<?php echo $img; ?>/web_design/ryukyu-urology.jp.webp" alt="医療機関のホームページ制作実績" width="480" height="360" loading="lazy" decoding="async">
                  <figcaption>医療機関</figcaption>
                </figure>
                <figure><img src="<?php echo $img; ?>/web_design/24c.jp.webp" alt="制作実績 24c.jp" width="480" height="360" loading="lazy">
                  <figcaption>店舗</figcaption>
                </figure>
                <figure><img src="<?php echo $img; ?>/web_design/higawa-parking.jp.webp" alt="制作実績 higawa-parking.jp" width="480" height="360" loading="lazy">
                  <figcaption>駐車場</figcaption>
                </figure>
                <figure><img src="<?php echo $img; ?>/web_design/glanz-amami.com.webp" alt="制作実績 glanz-amami.com" width="480" height="360" loading="lazy">
                  <figcaption>宿泊・観光</figcaption>
                </figure>
                <figure><img src="<?php echo $img; ?>/web_design/umui.co.jp.webp" alt="制作実績 umui.co.jp" width="480" height="360" loading="lazy">
                  <figcaption>福祉</figcaption>
                </figure>
                <figure><img src="<?php echo $img; ?>/web_design/inkankobo-han.com.webp" alt="制作実績 inkankobo-han.com" width="480" height="360" loading="lazy">
                  <figcaption>小売店舗</figcaption>
                </figure>
                <figure><img src="<?php echo $img; ?>/web_design/kitamura-ind.com.webp" alt="制作実績 kitamura-ind.com" width="480" height="360" loading="lazy">
                  <figcaption>工業</figcaption>
                </figure>
                <figure><img src="<?php echo $img; ?>/web_design/yamagen-syouten.com.webp" alt="制作実績 yamagen-syouten.com" width="480" height="360" loading="lazy">
                  <figcaption>卸売</figcaption>
                </figure>
                <figure><img src="<?php echo $img; ?>/web_design/okinawapump.com.webp" alt="制作実績 okinawapump.com" width="480" height="360" loading="lazy">
                  <figcaption>建設・工事</figcaption>
                </figure>
                <figure><img src="<?php echo $img; ?>/web_design/f-marui.com.webp" alt="制作実績 f-marui.com" width="480" height="360" loading="lazy">
                  <figcaption>サービス</figcaption>
                </figure>
                <figure><img src="<?php echo $img; ?>/web_design/itomansjc.or.jp.webp" alt="制作実績 itomansjc.or.jp" width="480" height="360" loading="lazy">
                  <figcaption>団体</figcaption>
                </figure>
                <figure><img src="<?php echo $img; ?>/web_design/nahawest-rotary.org.webp" alt="制作実績 nahawest-rotary.org" width="480" height="360" loading="lazy">
                  <figcaption>地域団体</figcaption>
                </figure>
                <figure><img src="<?php echo $img; ?>/web_design/yutaka-ema.com.webp" alt="制作実績 yutaka-ema.com" width="480" height="360" loading="lazy">
                  <figcaption>専門サービス</figcaption>
                </figure>
                <figure><img src="<?php echo $img; ?>/web_design/artdesignhakata.com.webp" alt="制作実績 artdesignhakata.com" width="480" height="360" loading="lazy">
                  <figcaption>デザイン</figcaption>
                </figure>
                <figure><img src="<?php echo $img; ?>/web_design/okikoken.co.jp.webp" alt="制作実績 okikoken.co.jp" width="480" height="360" loading="lazy">
                  <figcaption>建築</figcaption>
                </figure>
              </div>
            ...
            <div class="marutto_chart">
              ...
              <dl>
                <div>
                  <dt>建築・建設・工事</dt>
                  <dd><span style="--value:73%"></span><b>166</b></dd>
                </div>
                <div>
                  <dt>サービス</dt>
                  <dd><span style="--value:38%"></span><b>87</b></dd>
                </div>
                <div>
                  <dt>福祉施設</dt>
                  <dd><span style="--value:32%"></span><b>73</b></dd>
                </div>
                <div>
                  <dt>医院</dt>
                  <dd><span style="--value:22%"></span><b>51</b></dd>
                </div>
                <div>
                  <dt>小売店舗</dt>
                  <dd><span style="--value:21%"></span><b>49</b></dd>
                </div>
                <div>
                  <dt>工場・工業</dt>
                  <dd><span style="--value:17%"></span><b>39</b></dd>
                </div>
                <div>
                  <dt>卸売</dt>
                  <dd><span style="--value:17%"></span><b>38</b></dd>
                </div>
                <div>
                  <dt>保育園・幼稚園</dt>
                  <dd><span style="--value:13%"></span><b>30</b></dd>
                </div>
                <div>
                  <dt>飲食</dt>
                  <dd><span style="--value:12%"></span><b>28</b></dd>
                </div>
                <div>
                  <dt>その他各種</dt>
                  <dd><span style="--value:100%"></span><b>228</b></dd>
                </div>
              </dl>
            </div>
          </div>
    ...
    <section>
      <div class="marutto_section marutto_voices">
        <div class="marutto_inner">
          <div class="marutto_heading">
            <p>Voice</p>
            <h2>“作って終わり”<br class="sponly">じゃない、続く成果。</h2>
          </div>
          <div class="marutto_voice_grid">
            <article>
              <div class="marutto_voice_person"><img src="<?php echo $img; ?>/voice-nicoli-arakaki.jpg" alt="ニコリミュージック代表 新垣里実さま" width="480" height="720" loading="lazy">
                <p><small>音楽教室経営</small><strong>ニコリミュージック代表<br>新垣 里実 様</strong></p>
              </div>
              <h3>“作って終わり”じゃない。<br>毎年60件、問い合わせが続いています。</h3>
            ...
            <article>
              <div class="marutto_voice_person"><img src="<?php echo $img; ?>/voice-yukyunotabi-ura.jpg" alt="悠久の旅 沖縄 代表 宇良さま" width="480" height="480" loading="lazy">
                <p><small>旅行代理店経営</small><strong>悠久の旅 沖縄<br>代表 宇良 様</strong></p>
              </div>
              <h3>“本能にぶっ刺さるチラシ”で即決契約。<br>第2弾を即決受注！</h3>
            ...
            <article>
              <div class="marutto_voice_person"><span class="marutto_voice_avatar"><i class="fa-solid fa-store" aria-hidden="true"></i></span>
                <p><small>飲食業</small><strong>株式会社バリューボックス<br>代表 屋良 竜紀 様</strong></p>
              </div>
    ...
    <section>
      <div id="plan" class="marutto_section marutto_pricing">
        <div class="marutto_inner">
          <div class="marutto_heading">
            <p>Price</p>
            <h2>シンプルな月額制。<br class="sponly"><strong>制作費は0円</strong>です。</h2>
          </div>
          <div class="marutto_price_layout">
            <div class="marutto_price_card">
              ...
              <p class="marutto_price_note">※ 今お持ちのHPと新規制作もOK！</p>
            </div>
          ...
          <div class="marutto_package">
            <div>
              ...
              <ul>
                <li>6ページ制作＋TOPアニメ</li>
                <li>ページ追加OK！</li>
                <li>サーバー・ドメイン費 コミコミ</li>
                <li>SSL・スマホ・タブレット対応</li>
                <li>ブログシステム設置</li>
                <li>お問合せフォーム／SNS連携</li>
                <li>Google Map（MEO）サポート</li>
                <li><strong>年2回のチラシ制作込み</strong></li>
                <li>各種印刷物の相談サポート</li>
                <li>決済システム別途相談OK！</li>
                <li>予約管理別途相談OK！</li>
                <li>デザインの追加修正いつでもOK</li>
              </ul>
            </div>
            <aside>
              <h3>オプション</h3>
              ...
              <p>必要な機能だけ、事前に分かりやすくお見積りします。</p>
            </aside>
          </div>
          <div class="marutto_section_action"><a class="marutto_cta" href="<?php echo htmlspecialchars($marutto_page_path, ENT_QUOTES, 'UTF-8'); ?>#contact_form"><i class="fa-regular fa-envelope" aria-hidden="true"></i><span>まずは無料相談する<small>料金や契約についてご説明OK！</small></span><i class="fa-solid fa-chevron-down" aria-hidden="true"></i></a></div>
        </div>
      </div>
    </section>
        ...
        <div class="marutto_inner">
          ...
          <div class="marutto_profile_grid">
            <div class="marutto_profile_intro">
              ...
              <div>
                <p class="marutto_profile_role">現場経験型Web制作者 ／ 1984年 沖縄県生まれ</p>
                <h3 class="tcenter"><?php echo htmlspecialchars($name, ENT_QUOTES, 'UTF-8'); ?> <small>（ガーヒー＠ネコ好き）</small></h3>
                <p>名刺1枚から、チラシやポスター、飲食店のメニューまで、撮影から取材・デザインまで幅広く対応してきました。10年以上、1,000件以上のホームページ制作を経験。取材・撮影・デザイン・コーディング・ライティング全てを一貫して担当してきた現場経験型Web制作者です。</p>
              </div>
            </div>
            <div class="marutto_profile_thought">
              <h3 class="fs_sp25 tcenter">「作って終わり」ではなく、<br>「育てる」という発想</h3>
              <p>1,000件超の制作現場を経験する中で感じたのは、多くのホームページが「作ったまま更新されていない」ということでした。本当に大切なのは、ホームページを“作る”ことではなく“育てる”こと。</p>
              <p>その想いから、デザネコでは小さなお店の“外部Web担当”として、ホームページ制作・チラシ・撮影・SNS運用まで一括でサポートしています。</p>
            </div>
          </div>
          <div class="marutto_timeline">
            <h3>これまでの歩み</h3>
            <ol>
              <li><strong>1984年</strong>
                <p>沖縄県で生まれる。友人から「デザイナーに向いているんじゃない？」と言われたのが、この道に進むきっかけ。</p>
              </li>
              <li><strong>20代前半</strong>
                <p>広告代理店でデザイナー勤務。大手スーパー・デパートのチラシ、広告印刷物を担当。</p>
              </li>
              <li><strong>20代後半</strong>
                <p>沖縄県内13店舗以上の飲食業界の専属デザイナー。撮影・編集・印刷・企画まで全工程を担当。</p>
              </li>
              <li><strong>30代</strong>
                <p>沖縄県内最多級の実績を持つHP制作会社に勤務。1,000件以上のHPを担当。</p>
              </li>
              <li><strong>現在</strong>
                <p>AIを活用したクリエイティブに注力。動画・音楽・画像生成でお客様の価値を最大化。</p>
              </li>
            </ol>
          </div>
          <div class="marutto_cats">
            <div><img src="<?php echo $img; ?>/about-renewal/moja-laptop.png" alt="パソコンを使う黒猫のもじゃ" width="370" height="320" loading="lazy"><img src="<?php echo $img; ?>/about-renewal/kururu-laptop.png" alt="タブレットを使う白猫のくるる" width="370" height="320" loading="lazy"></div>
            <p>相棒の看板猫<br class="sponly">「もじゃ」と「くるる」が、<br>あなたの商売のネコの手に<br class="sponly">なれたら嬉しいです<i class="fa-solid fa-paw" aria-hidden="true"></i></p>
          </div>
      ...
      <div class="marutto_section marutto_faq">
        <div class="marutto_inner">
          ...
          <div class="marutto_faq_grid">
            <details open>
              <summary><span>Q1.</span> 制作費が本当に0円ですか？<i class="fa-solid fa-plus" aria-hidden="true"></i></summary>
              <p>はい。月額のみでスタートでき、初期費用は一切いただきません。</p>
            </details>
            <details>
              <summary><span>Q2.</span> 契約期間の縛りはありますか？<i class="fa-solid fa-plus" aria-hidden="true"></i></summary>
              <p>ございません。合わないと感じたら、いつでも解約OKです。</p>
            </details>
            <details>
              <summary><span>Q3.</span> 印刷代は月額に含まれますか？<i class="fa-solid fa-plus" aria-hidden="true"></i></summary>
              <p>デザイン制作費のみ含まれます。印刷代は部数・仕様により別途実費でご案内します。</p>
            </details>
            <details>
              <summary><span>Q4.</span> HP公開までどれくらいかかりますか？<i class="fa-solid fa-plus" aria-hidden="true"></i></summary>
              <p>お打ち合わせから約1〜2ヶ月が目安です。</p>
            </details>
            <details>
              <summary><span>Q5.</span> 写真や文章は自分で準備が必要ですか？<i class="fa-solid fa-plus" aria-hidden="true"></i></summary>
              <p>ご不要です。取材・撮影・執筆までこちらでお手伝いします。</p>
            </details>
            <details>
              <summary><span>Q6.</span> 今持っているHPと並行でも大丈夫？<i class="fa-solid fa-plus" aria-hidden="true"></i></summary>
              <p>大丈夫です。切り替え時期や告知は無理のないタイミングでご相談しながら進めます。</p>
            </details>
            <details>
              <summary><span>Q7.</span> 遠方からの依頼でも対応できますか？<i class="fa-solid fa-plus" aria-hidden="true"></i></summary>
              <p>はい、可能です。オンラインでの打ち合わせやデータ共有にも対応しております。</p>
            </details>
            <details>
              <summary><span>Q8.</span> デザインの修正は何回までできますか？<i class="fa-solid fa-plus" aria-hidden="true"></i></summary>
              <p>基本的な修正は2〜3回まで無料で対応。それ以降の修正や大幅な変更が必要な場合は、事前にご案内いたします。</p>
            </details>
          </div>
          <div class="marutto_section_action"><a class="marutto_cta marutto_cta_compact" href="<?php echo htmlspecialchars($marutto_page_path, ENT_QUOTES, 'UTF-8'); ?>#contact_form"><i class="fa-regular fa-envelope" aria-hidden="true"></i><span>まずは無料相談する<small>小さな疑問にもお答えします</small></span><i class="fa-solid fa-chevron-down" aria-hidden="true"></i></a></div>
        </div>
      </div>
    </section>
          ...
          <div class="marutto_company_layout">
            <table>
              <tbody>
                <tr>
                  <th scope="row">屋号</th>
                  <td><?php echo htmlspecialchars($company, ENT_QUOTES, 'UTF-8'); ?>（デザインのネコの手）</td>
                </tr>
                <tr>
                  <th scope="row">設立日</th>
                  <td>2015年</td>
                ...
                <tr>
                  <th scope="row">代表</th>
                  <td><?php echo htmlspecialchars($name, ENT_QUOTES, 'UTF-8'); ?>（ガーヒー）</td>
                </tr>
                <tr>
                  <th scope="row">所在地</th>
                  <td><?php echo htmlspecialchars($postalCode, ENT_QUOTES, 'UTF-8'); ?> <?php echo htmlspecialchars($address, ENT_QUOTES, 'UTF-8'); ?></td>
                </tr>
                <tr>
                ...
                <tr>
                  ...
                  <td>PayPal（JCB／VISA／MasterCard／American Express）／銀行振込／PayPay ほか</td>
                </tr>
                <tr>
                  <th scope="row">Web</th>
                  <td><a href="https://d-neko.com/">https://d-neko.com</a></td>
                </tr>
              </tbody>
            </table>
            <img src="<?php echo $img; ?>/about-renewal/moja-laptop.png" alt="パソコンで制作する黒猫のもじゃ" width="370" height="320" loading="lazy">
          </div>
          <div class="marutto_section_action"><a class="marutto_cta marutto_cta_compact" href="<?php echo htmlspecialchars($marutto_page_path, ENT_QUOTES, 'UTF-8'); ?>#contact_form"><i class="fa-regular fa-envelope" aria-hidden="true"></i><span>まずは無料相談する<small>沖縄・宜野湾から丁寧に対応</small></span><i class="fa-solid fa-chevron-down" aria-hidden="true"></i></a></div>
        </div>
      </div>
    </section>
      ...
      <div class="marutto_final">
        <div class="marutto_inner">
          ...
          <div class="marutto_contact_grid">
            ...
            <a class="is_mail" href="<?php echo htmlspecialchars($marutto_page_path, ENT_QUOTES, 'UTF-8'); ?>#contact_form"><i class="fa-regular fa-envelope" aria-hidden="true"></i><span><small>24時間受付</small><strong>お問い合わせフォームで送る</strong></span><i class="fa-solid fa-chevron-right" aria-hidden="true"></i></a>
          </div>
          <p class="marutto_final_message">沖縄・宜野湾から、<br>あなたの商売の“ネコの手”に<br class="sponly">なれたら嬉しいです<i class="fa-solid fa-paw" aria-hidden="true"></i><br><small>— <?php echo htmlspecialchars($company, ENT_QUOTES, 'UTF-8'); ?> <?php echo htmlspecialchars($name, ENT_QUOTES, 'UTF-8'); ?>（ガーヒー）</small></p>
        </div>
      </div>
    </section>
...
<script type="application/ld+json">
  {
    ...
    "mainEntity": [{
        ...
        "acceptedAnswer": {
          "@type": "Answer",
          "text": "はい。月額のみでスタートでき、初期費用は一切いただきません。"
        }
      },
      {
        "@type": "Question",
        ...
        "acceptedAnswer": {
          "@type": "Answer",
          "text": "ございません。合わないと感じたら、いつでも解約OKです。"
        }
      },
      {
        "@type": "Question",
        ...
        "acceptedAnswer": {
          "@type": "Answer",
          "text": "デザイン制作費のみ含まれます。印刷代は部数・仕様により別途実費でご案内します。"
        }
      },
      {
        "@type": "Question",
        "name": "HP公開までどれくらいかかりますか？",
        "acceptedAnswer": {
          "@type": "Answer",
          "text": "お打ち合わせから約1〜2ヶ月が目安です。"
        }
      },
      {
        "@type": "Question",
        "name": "写真や文章は自分で準備が必要ですか？",
        "acceptedAnswer": {
          "@type": "Answer",
          "text": "ご不要です。取材・撮影・執筆までこちらでお手伝いします。"
        }
      },
      {
        "@type": "Question",
        "name": "今持っているHPと並行でも大丈夫？",
        "acceptedAnswer": {
          "@type": "Answer",
          "text": "大丈夫です。切り替え時期や告知は無理のないタイミングでご相談しながら進めます。"
        }
      },
      {
        "@type": "Question",
        "name": "遠方からの依頼でも対応できますか？",
        "acceptedAnswer": {
          "@type": "Answer",
          "text": "はい、可能です。オンラインでの打ち合わせやデータ共有にも対応しております。"
        }
      },
      {
        "@type": "Question",
        "name": "デザインの修正は何回までできますか？",
        "acceptedAnswer": {
          "@type": "Answer",
          "text": "基本的な修正は2〜3回まで無料で対応。それ以降の修正や大幅な変更が必要な場合は、事前にご案内いたします。"
        }
      }
    ]
  }
